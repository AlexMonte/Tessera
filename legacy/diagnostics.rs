...
use crate::types::{EdgeId, GridPos, PortRole, PortType, TileSide};
...
pub enum DiagnosticKind {
    ...
    PatternOperatorMissingTarget {
        path: Vec<usize>,
    },
    PatternOperatorMissingArgument {
        path: Vec<usize>,
    },
    PatternConsecutiveOperators {
        path: Vec<usize>,
    },
    PatternTypeMismatch {
        path: Vec<usize>,
